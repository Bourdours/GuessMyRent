...
class UserModel extends Model
{
    ...
    public function create(
        ...
        $this->executeQueryWithBind(
            'INSERT INTO USER_ (email, password, pseudo, avatar, is_admin)
    ...
    public function updateProfile(int $id, ?string $pseudo, ?string $avatar): bool
    {
        return $this->executeQueryWithBind(
            'UPDATE USER_ SET pseudo = :pseudo, avatar = :avatar WHERE id_user = :id',
    ...
    {
        return $this->executeQueryWithBind(
            'UPDATE USER_ SET email = :email WHERE id_user = :id',
    ...
    {
        return $this->executeQueryWithBind(
            'UPDATE USER_ SET password = :password WHERE id_user = :id',
